...
HOST = '98.94.69.132'
PORT = 32440
WINDOW = 86400  # 24 horas; aumente se necessário
...
def generate_flag(seed, method):
    ...
    if method == 'random_int':
        ...
        return hex(seed).encode()
    elif method == 'seed_bytes_little':
        return seed.to_bytes(8, 'little')
...
def main():
    ...
    methods = [
        ...
        'flag_hex16', 'flag_hex32',
        'flag_alnum16', 'flag_alnum32',
        'random_string64', 'uuid4',
